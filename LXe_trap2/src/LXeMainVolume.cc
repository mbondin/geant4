                 ...
                 "housing",pMotherLogical,pMany,pCopyNo),fConstructor(c)
{
  ...
  G4Box* Box1 = new G4Box("Box1", 2.1*cm*zz,2.1*cm*zz,1.0*cm*zz);
  ...
  G4Trap* Trap1 = new G4Trap("Trap1",3.5*cm*zz,0*degree,0*degree,0.25*cm*zz,0.25*cm*zz,0.25*cm*zz,0*degree,1.0*cm*zz,1.0*cm*zz,1.0*cm*zz,0*degree);
  G4Trap* Trap2 = new G4Trap("Trap2",0.25*cm*zz,0*degree,0*degree,0.25*cm*zz,0.25*cm*zz,0.25*cm*zz,0*degree,0.95*cm*zz,0.95*cm*zz,0.95*cm*zz,0*degree);
  ...
  G4SubtractionSolid* solid0 = new G4SubtractionSolid("solid1", Trap1, Box1, 0, G4ThreeVector(0*cm*zz,0*cm*zz,4.0*cm*zz));
  G4UnionSolid* solid1 = new G4UnionSolid("solid1", solid0,Trap2 , rm4,G4ThreeVector(0*cm*zz, 0.0*cm*zz, 3.25 * cm*zz));
