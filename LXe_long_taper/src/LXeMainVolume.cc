                 ...
                 "housing",pMotherLogical,pMany,pCopyNo),fConstructor(c)
{
 ...
 //** 
//** long taper trap
  G4double increament_n = 50 ;
  G4double increament_nn = 0.01;
  G4double dx2 = (width-(increament_n*increament_nn)*in*cm)/2 ;
  G4double dx1 = width/2;
  G4double dy2 = width/2 ;
  G4double dy1 = width/2;
  ...
  G4Trd* Trap0 = new G4Trd("Trap0",dx1,dx2,dy1,dy2,dz1);
  ...
  G4UnionSolid* solid0 = new G4UnionSolid("solid0", Trap0,Trap1 , 0,G4ThreeVector(-shift/2,-shift/2, -length/2-trap_H/2));
  ...
  new G4PVPlacement(rm2,G4ThreeVector(-shift,-shift,trap_H/2),fScint_log,"scintillator",
