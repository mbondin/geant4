                 ...
                 "housing",pMotherLogical,pMany,pCopyNo),fConstructor(c)
{
  ...
  fScint_box =  new G4Box("scint_box",width/2*zz*cm ,height/2*zz*cm ,length/2*zz*cm);
  fHousing_box = new G4Box("housing_box", width*zz*cm*stretch,height*zz*cm*stretch,length*zz*cm*stretch);
