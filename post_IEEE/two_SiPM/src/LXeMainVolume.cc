...
//** far trap
  ...
  fHousing_box = new G4Box("housing_box",side_L*3,side_L*6 ,lL*17/32);

  G4Box* Box1 = new G4Box("Box1", side_L/2,side_L/2,length/2);
  G4Trap* Trap1 = new G4Trap("Trap1",trap_H/2,angle,0,SiPM_height/2,SiPM_width/2,SiPM_width/2,0*degree,side_L/2,side_L/2,side_L/2,0*degree);
  ...
  fPhotocath = new G4Box("photocath_tube",0.7*cm, 0.7*cm, height_pmt);
