...
LXeRunAction::LXeRunAction() //: fRun(nullptr)//, fHistoManager(nullptr)
{
  ...
  analysisManager->SetFileName("LXe_T_4");
  // Creating histograms
  ...
  //create Ntuple
  analysisManager->CreateNtuple("LXe_D_12", "Data");
  analysisManager->CreateNtupleDColumn("LXe_D_12_Energy_deposited");  // column Id = 0
  analysisManager->CreateNtupleDColumn("LXe_D_12_SiPM_hits");  // column Id = 1
  analysisManager->CreateNtupleDColumn("LXe_D_12_Photons_Created"); // column Id = 2
