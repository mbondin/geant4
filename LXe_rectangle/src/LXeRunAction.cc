...
LXeRunAction::LXeRunAction() //: fRun(nullptr)//, fHistoManager(nullptr)
{
  ...
  analysisManager->SetFileName("LXe_PolishedTeflon_LUT");
  // Creating histograms
  ...
  //create Ntuple
  analysisManager->CreateNtuple("LXe_dielectric_metal", "Data");
  analysisManager->CreateNtupleDColumn("LXe_dielectric_metal_Energy_deposited");  // column Id = 0
  analysisManager->CreateNtupleDColumn("LXe_dielectric_metal_SiPM_hits");  // column Id = 1
  analysisManager->CreateNtupleDColumn("LXe_dielectric_metal_Photons_Created"); // column Id = 2
 // analysisManager->CreateNtupleDColumn("LXe_D_0_SiPM_per_hit"); // column Id = 3
